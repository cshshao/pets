...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">宠物领养管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>宠物领养管理</span></li>
								<li class="breadcrumb-item active"><span>宠物领养列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宠物领养列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<label>审核状态</label>
									<select id="sfshSearch" name="sfsh" class="form-control">
											<option value=""></option>
											<option class="sfshOption" value="是">
												是
											</option>
											<option class="sfshOption" value="否">
												否
											</option>
									</select>	
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shenqingneirong')">申请内容<i id="shenqingneirongIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			debugger
			if($('#sfshSearch').val() != null && $('#sfshSearch').val() != ''){
				searchForm.sfsh =$('#sfshSearch').val();
			}
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("chongwulingyang/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("chongwulingyang/update?flag=1","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chongwulingyang/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("chongwulingyang"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"chongwulingyang");
