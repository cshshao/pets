		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑宠物领养</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑宠物领养</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宠物领养信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>宠物分类</label>
										<input id="chongwufenlei" name="chongwufenlei" class="form-control" placeholder="宠物分类">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										<label>状态</label>
										<input id="zhuangtai" name="zhuangtai" class="form-control" placeholder="状态">
									</div>
									<div class="form-group col-md-6">
										<label>申请日期</label>
									...
									<div class="form-group col-md-6">
										<label>申请内容</label>
										<input id="shenqingneirong" name="shenqingneirong" class="form-control" placeholder="申请内容">
									</div>
									<div class="form-group col-md-6">
										<label>用户名</label>
									...
									<div class="form-group col-md-6">
										<label>家庭住址</label>
										<input id="jiatingzhuzhi" name="jiatingzhuzhi" class="form-control" placeholder="家庭住址">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chongwulingyang/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("chongwulingyang/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.jiatingzhuzhi != null && res.data.jiatingzhuzhi != ''){
		...
		function dataBind(){
			...
			$("#zhuangtai").val(ruleForm.zhuangtai);	
