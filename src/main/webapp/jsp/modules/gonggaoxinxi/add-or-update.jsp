...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>公告类型</label>
										<input id="gonggaoleixing" name="gonggaoleixing" class="form-control" placeholder="公告类型">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#gonggaoleixing").val(ruleForm.gonggaoleixing);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.gonggaoleixing != null && res.data.gonggaoleixing != ''){

					$("#gonggaoleixing").val(res.data.gonggaoleixing);
					}
