						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="pinzhong" name="pinzhong" class="form-control" v-model="ruleForm.pinzhong" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>图片</label>
									...
									<input id="xingqing" name="xingqing" class="form-control" v-model="ruleForm.xingqing" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>状态</label>

									<input id="zhuangtai" name="zhuangtai" class="form-control" v-model="ruleForm.zhuangtai" readonly>
									</div>
