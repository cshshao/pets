		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑宠物信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑宠物信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宠物信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>宠物名称</label>
										<input id="chongwumingcheng" name="chongwumingcheng" class="form-control" placeholder="宠物名称">
									</div>
									<div class="form-group col-md-6">
										<label>宠物分类</label>
									...
									<div class="form-group col-md-6">
										<label>品种</label>
										<input id="pinzhong" name="pinzhong" class="form-control" placeholder="品种">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										<label>性情</label>
										<input id="xingqing" name="xingqing" class="form-control" placeholder="性情">
									</div>
									<div class="form-group col-md-6">
										<label>状态</label>
										<select id="zhuangtaiSelect" name="zhuangtai" class="form-control">
												<option value=""></option>
												<option class="zhuangtaiOption" value="待领养">
													待领养
												</option>
												<option class="zhuangtaiOption" value="已领养">
													已领养
												</option>
										</select>	
									</div>	
											...
											<div class="form-group  col-md-12">
												<label>宠物详情</label>
												<div><div class="upload"><input id="chongwuxiangqingupload" name="file" type="file">选择文件</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chongwuxinxi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("chongwuxinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getContent(){
			if(UE.getEditor('chongwuxiangqingEditor').hasContents()){
				$('#chongwuxiangqing-input').attr('value',UE.getEditor('chongwuxiangqingEditor').getPlainTxt());
			}
		}
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chongwuxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#pinzhong").val(ruleForm.pinzhong);	
			...
			$("#xingqing").val(ruleForm.xingqing);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.pinzhong != null && res.data.pinzhong != ''){

					$("#pinzhong").val(res.data.pinzhong);
					}
					...
					if(res.data != null && res.data != '' && res.data.xingqing != null && res.data.xingqing != ''){

					$("#xingqing").val(res.data.xingqing);
					}
