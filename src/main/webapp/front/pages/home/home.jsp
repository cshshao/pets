...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in chongwuxinxiRecommend" v-bind:key="index">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in gonggaoxinxiList" v-bind:key="index">
                <a target="_self" :href="'../gonggaoxinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.tupian?item.tupian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`chongwuxinxi/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
