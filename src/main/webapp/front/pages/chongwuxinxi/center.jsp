				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="chongwufenlei" id="chongwufenlei">
							...
							<div class="layui-input-block">
								<input type="text" name="pinzhong" id="pinzhong" placeholder="品种" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="xingqing" id="xingqing" placeholder="性情" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
