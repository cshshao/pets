			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.chongwumingcheng" type="text" name="chongwumingcheng" id="chongwumingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">宠物分类</label>
                        <div class="layui-input-block">
                            <select name="chongwufenlei" id="chongwufenlei" lay-filter="chongwufenlei">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in chongwufenlei" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.pinzhong" type="text" name="pinzhong" id="pinzhong" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.xingqing" type="text" name="xingqing" id="xingqing" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																...
                																http.request(`option/chongwufenlei/chongwufenlei`,'get',{},(res)=>{
					vue.chongwufenlei = res.data
				});
																								// 上传图片
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																								...
																								vue.xingbie = '公,母'.split(',')
																								vue.zhuangtai = '待领养,已领养'.split(',')
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('chongwuxinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
