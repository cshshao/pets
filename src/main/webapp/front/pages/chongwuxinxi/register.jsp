      ...
      <div class="form-inner">
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="pinzhong" name="pinzhong" placeholder="请输入品种" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="xingqing" name="xingqing" placeholder="请输入性情" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
